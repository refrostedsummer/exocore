...
<style>
  ...
  <body>
    <div id="wrapper">
      <h1>tirestires — shadowdog <em>(2015)</em></h1>
      <audio preload></audio>
      <ol>
        <li><a href="#" src="../assets/attachments/shadodog/1.mp3">dead wrong intro</a></li>
        <li><a href="#" data-src="../assets/attachments/shadodog/1.mp3">juicy-r</a></li>
        <li><a href="#" data-src="../assets/attachments/shadodog/1.mp3">it's all about the crystalizabeths</a></li>
        <li><a href="#" data-src="../assets/attachments/shadodog/1.mp3">islands is the limit</a></li>
        <li><a href="#" data-src="../assets/attachments/shadodog/1.mp3">one more chance for a heart to skip a beat</a></li>
        <li><a href="#" data-src="../assets/attachments/shadodog/1.mp3">suicidal fantasy</a></li>
        <li><a href="#" data-src="../assets/attachments/shadodog/1.mp3">everyday shelter</a></li>
